...
import com.example.domain.MyRegion;
...
public class CityUtils {
	 ...
	 * 
	 * // 注意：SimpleDateFormat构造函数的样式与strDate的样式必须相符 SimpleDateFormat
	 * simpleDateFormat1 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	 * 
	 * Date date1 = null; try { date1 = simpleDateFormat1.parse(date); } catch
	 * (ParseException e) { e.printStackTrace(); } Calendar calendar =
	 * Calendar.getInstance(); calendar.setTime(date1); // 加上1天
	 * calendar.add(Calendar.DAY_OF_YEAR, day); // 时间格式化 String str =
	 * simpleDateFormat1.format(calendar.getTime()); System.out.println(str);
	 * return str;
	 * 
	 * }
	 */
